...
#ifndef COMPONENTKIT_SWIFT_H
#define COMPONENTKIT_SWIFT_H
...
SWIFT_CLASS("_TtC12ComponentKit12ComponentKit")
@interface ComponentKit : NSObject
...
SWIFT_CLASS("_TtC12ComponentKit21ComponentKitDataModel")
@interface ComponentKitDataModel : NSObject <NSCoding>
@property (nonatomic, copy) NSString * _Nullable businessName;
@property (nonatomic, copy) NSString * _Nullable address;
@property (nonatomic, copy) NSString * _Nullable distanceString;
...
@property (nonatomic, strong) UIImage * _Nullable mapIcon;
@property (nonatomic, strong) UIImage * _Nullable businessLogo;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12ComponentKit19ComponentKitRequest")
@interface ComponentKitRequest : NSObject
@property (nonatomic, copy) NSArray<ComponentKitDataModel *> * _Nonnull aryDataModel;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12ComponentKit20ComponentKitResponse")
@interface ComponentKitResponse : NSObject
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable dataDictionary;
@property (nonatomic, copy) NSString * _Nullable errorMsg;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12ComponentKit13MapAnnotation")
@interface MapAnnotation : NSObject
+ (void)getAnnotation:(ComponentKitRequest * _Nullable)request callback:(void (^ _Nonnull)(ComponentKitResponse * _Nullable))callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12ComponentKit7MapIcon")
@interface MapIcon : NSObject
+ (void)getImage:(ComponentKitRequest * _Nullable)request callback:(void (^ _Nonnull)(ComponentKitResponse * _Nullable))callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSBundle;

SWIFT_CLASS("_TtC12ComponentKit14ProgressDialog")
@interface ProgressDialog : UIViewController
...
SWIFT_PROTOCOL("_TtP12ComponentKit14PulleyDelegate_")
...
SWIFT_PROTOCOL("_TtP12ComponentKit34PulleyDrawerViewControllerDelegate_")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC12ComponentKit14PulleyPosition")
...
SWIFT_PROTOCOL("_TtP12ComponentKit38PulleyPrimaryContentControllerDelegate_")
...
SWIFT_CLASS("_TtC12ComponentKit20PulleyViewController")
...
@property (nonatomic) IBInspectable CGFloat panelInsetLeft;
/// When in ‘leftSide’ displayMode, this is used to calculate the top inset from the edge of the screen.
@property (nonatomic) IBInspectable CGFloat panelInsetTop;
...
@interface PulleyViewController (SWIFT_EXTENSION(ComponentKit)) <UIScrollViewDelegate>
...
SWIFT_CLASS("_TtC12ComponentKit13ScrollingBlur")
@interface ScrollingBlur : UIImageView
@property (nonatomic, strong) UIImage * _Nullable originalImage;
@property (nonatomic, strong) UIColor * _Nullable glassColor;
@property (nonatomic, strong) UIImageView * _Nullable backgroundImageView;
@property (nonatomic, strong) UIView * _Nullable backgroundGlassView;
...
@interface UIImage (SWIFT_EXTENSION(ComponentKit))
+ (NSString * _Nullable)IPBtest SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)IPBapplyLightEffect SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)IPBapplyExtraLightEffect SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)IPBapplyDarkEffect SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)IPBapplyTintEffectWith:(UIColor * _Nonnull)tintColor SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)IPBapplyBlurWithRadius:(CGFloat)blurRadius tintColor:(UIColor * _Nullable)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage * _Nullable)maskImage SWIFT_WARN_UNUSED_RESULT;
@end
